...
| workclass       | Self-emp-not-inc     | Self-employed without incorporated business status                          |
| workclass       | Self-emp-inc         | Self-employed with an incorporated business                                 |
| workclass       | Federal-gov          | Employed by the federal government                                          |
| workclass       | State-gov            | Employed by a state government                                              |
| workclass       | Local-gov            | Employed by a local government                                              |
| workclass       | Without-pay          | Works without receiving pay (e.g. unpaid family worker)                     |
| workclass       | Never-worked         | Has never worked in their lifetime                                          |
| education       | Bachelors            | Bachelor's degree                                                           |
| education       | Some-college         | Some college courses completed, no degree                                  |
| education       | 11th                 | 11th grade completed                                                        |
| education       | HS-grad              | High school graduate                                                        |
| education       | Prof-school          | Professional school (e.g. law, medicine)                                    |
| education       | Assoc-acdm           | Associate degree (academic)                                                 |
| education       | Assoc-voc            | Associate degree (vocational)                                               |
| education       | 9th                  | 9th grade completed                                                         |
| education       | 7th-8th              | 7th or 8th grade completed                                                  |
| education       | 12th                 | 12th grade, no diploma                                                      |
| education       | Masters              | Master's degree                                                             |
| education       | 1st-4th              | 1st to 4th grade completed                                                  |
| education       | 10th                 | 10th grade completed                                                        |
| education       | Doctorate            | Doctoral degree                                                             |
| education       | 5th-6th              | 5th or 6th grade completed                                                  |
| education       | Preschool            | Preschool education                                                         |
| marital-status  | Married-civ-spouse   | Married, living with spouse                                                 |
| marital-status  | Divorced             | Divorced legally                                                            |
| marital-status  | Never-married        | Never married                                                               |
| marital-status  | Separated            | Separated legally but not divorced                                          |
| marital-status  | Widowed              | Spouse deceased                                                             |
| marital-status  | Married-spouse-absent| Married, spouse not present (e.g. estrangement)                             |
| marital-status  | Married-AF-spouse    | Married to a spouse in the Armed Forces                                     |
| occupation      | Tech-support         | Technical support jobs                                                      |
| occupation      | Craft-repair         | Skilled manual trade and repair jobs                                        |
| occupation      | Other-service        | Services not classified elsewhere                                           |
| occupation      | Sales                | Sales-related jobs                                                          |
| occupation      | Exec-managerial      | Executive and managerial roles                                              |
| occupation      | Prof-specialty       | Professional specialty occupations (e.g. scientist, lawyer)                |
| occupation      | Handlers-cleaners    | Manual labor jobs involving cleaning, handling objects                      |
| occupation      | Machine-op-inspct    | Machine operators, inspectors                                               |
| occupation      | Adm-clerical         | Administrative and clerical jobs                                            |
| occupation      | Farming-fishing      | Agriculture, farming, fishing occupations                                   |
| occupation      | Transport-moving     | Transport and moving equipment operators                                    |
| occupation      | Priv-house-serv      | Private household service jobs                                              |
| occupation      | Protective-serv      | Protective service jobs (e.g. security, law enforcement)                    |
| occupation      | Armed-Forces         | Military service                                                            |
| relationship    | Wife                 | Female spouse                                                               |
| relationship    | Own-child            | Biological or adopted child                                                 |
| relationship    | Husband              | Male spouse                                                                 |
| relationship    | Not-in-family        | Not part of a family unit (e.g. living alone)                               |
| relationship    | Other-relative       | Other relative in household                                                 |
| relationship    | Unmarried            | Single person, not married                                                  |
| race            | White                | White                                                                       |
| race            | Asian-Pac-Islander   | Asian or Pacific Islander                                                   |
| race            | Amer-Indian-Eskimo   | American Indian or Eskimo                                                   |
| race            | Other                | Other race not listed                                                       |
| race            | Black                | Black                                                                       |
| sex             | Female               | Female                                                                      |
| sex             | Male                 | Male                                                                        |
...
| income          | >50K                 | Income greater than USD 50,000                                              |
...
```{python}
#| label: tbl-updated-dataset-overview
#| tbl-cap: Overview of adjusted columns 
new_df = pd.DataFrame({
    'Column': adult_df.columns,
    'Data Type': adult_df.dtypes.values,
    'Missing Values': adult_df.isnull().sum().values
...
#| echo: false
#| output: false
#adult_df.to_csv("9.csv",index=False)
```
